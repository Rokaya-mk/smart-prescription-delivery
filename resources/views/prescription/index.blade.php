            ...
            <div class="card">
              ...
              <div class="card-header" >
                    ...
                    <table class="table table-striped">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">@lang('trans.geznder')</th>
                ...
                {{-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal{{$booking->user_id}}">
                    ...
                    <a href="{{route('new.prescription',[$booking->id])}}" class="btn btn-primary"> @lang('trans.write_prescription') </a>


                    @else 
                   <a href="{{route('prescription.show',[$booking->user_id,$booking->date])}}" class="btn btn-secondary">@lang('trans.view') @lang('trans.prescription')</a>
                    @endif
