...
<div class="row align-items-end">
    <div class="col-lg-8">
        <div class="page-header-title">
            ...
            <div class="d-inline">
                <h5>@lang('trans.departments')</h5>
                <span> @lang('trans.departments_liste') </span>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <nav class="breadcrumb-container" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="#">@lang('trans.department')</a>
                </li>
...
<div class="col-md-12">
       @if(Session::has('message'))
        ...
        @endif
    <div class="card">
        <div class="card-header"><h3> @lang('trans.data_table') </h3>
        ...
        <div class="card-body">
            <table id="data_table" class="table">
                ...
                <tbody>
                    ...
                    @else 
                    <td> @lang('trans.no_departments') </td>
                    @endif
